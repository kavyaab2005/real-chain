        ...
        <BrowserRouter>
          ...
          <nav style={{
            ...
            <div style={{ display:"flex", gap:"1.2rem", alignItems:"center", flexWrap:"wrap" }}>
              ...
              <Link to="/fractional" style={{ color:"#fff", textDecoration:"none" }}>Fractional</Link>
              <Link to="/list"       style={{ color:"#fff", textDecoration:"none" }}>List Property</Link>
              <Link to="/dashboard"  style={{ color:"#fff", textDecoration:"none" }}>Dashboard</Link>
              <Link to="/profile"    style={{ color:"#fff", textDecoration:"none" }}>My Profile</Link>
